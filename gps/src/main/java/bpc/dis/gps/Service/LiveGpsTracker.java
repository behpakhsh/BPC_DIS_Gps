...
public class LiveGpsTracker extends Service implements LocationListener {
    ...
    public LiveGpsTracker() {
        ...
        if (location == null) {
            gpsTrackerStatus = GpsTrackerStatus.UNHANDLED;
        } else if (MockLocationChecker.thereIsAnyMockLocationApp(getApplication())) {
            if (MockLocationChecker.isMockSettingsOn(getApplication())) {
    ...
    public LiveGpsTracker(Context context) {
